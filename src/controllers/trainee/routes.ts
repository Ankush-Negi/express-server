...
traineeRouter.use('/api', swaggerUi.serve, swaggerUi.setup(swaggerOptions));
...
*/
traineeRouter.get('/', authMiddleWare('getUsers', 'read'), validationHandler(validation.get), TraineeController.getAll);
...
*           $ref: '#/definitions/500Response'
*/
traineeRouter.post('/', authMiddleWare('getUsers', 'read'), validationHandler(validation.create), TraineeController.create);
...
*           $ref: '#/definitions/500Response'
*/
traineeRouter.put('/', authMiddleWare('getUsers', 'read'), validationHandler(validation.update), TraineeController.update);
